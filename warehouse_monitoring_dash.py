...
def update_dashboard(start_date, end_date, machine_id, error_codes):
    ...
    # Error Code Distribution (Line Chart)
    error_distribution = (
    ...
    error_distribution_chart = px.line(
        error_distribution,
        x="error_code",
        y="count",
    ...
    # Tasks per Machine (Line Chart)
    tasks_per_machine = (
        filtered_df.groupby("machine_id")
        .size()
        .reset_index(name="Number of Tasks")
    )
    machine_performance_chart = px.line(
        tasks_per_machine,
        x="machine_id",
        y="Number of Tasks",
        title="Tasks per Machine",
        labels={"machine_id": "Machine", "Number of Tasks": "Number of Tasks"},
        template="plotly_white"
    )
    ...
    return (
        ...
        error_distribution_chart,  # Updated to line chart
        machine_performance_chart,  # Updated to line chart
